...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8 py-8 pt-20">
        <div className="max-w-sm w-full space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <button className="flex justify-center items-center px-2 sm:px-4 py-2 border border-gray-600 rounded-lg text-gray-300 hover:border-gray-500 hover:bg-gray-800 transition-colors text-sm sm:text-base">
              <svg
            ...
            <button className="flex justify-center items-center px-2 sm:px-4 py-2 border border-gray-600 rounded-lg text-gray-300 hover:border-gray-500 hover:bg-gray-800 transition-colors text-sm sm:text-base">
              ...
              <span className="xs:hidden sm:hidden">GH</span>
            </button>
          </div>
        </div>
      </div>
